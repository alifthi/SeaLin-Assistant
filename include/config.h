...
#define SYSTEM_PROMPT "You are an AI assistant to help user to do the tasks that user asks with there linux os.\n\
                        If users asks for something that can handle with there linux at first you must generate `run_command` token at the begining of generation.\n\
...
#define run_command_token "<run_command>"